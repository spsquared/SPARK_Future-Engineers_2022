...
function showWallData() {
    ...
    ctx2.fillStyle = '#FFF9';
    for(let i = 0; i < 20; i++) {
        ctx2.fillRect(i*4, 56-data[3][i]/2+data[6][i], 1, data[3][i]);
    }
    for(let i = 0; i < 20; i++) {
        ctx2.fillRect(i*4+96, 56-data[4][i]/2+data[7][i], 1, data[4][i]);
    }
    for(let i = 0; i < 20; i++) {
        ctx2.fillRect(i*4+192, 56-data[5][i]/2+data[8][i], 1, data[5][i]);
    }
